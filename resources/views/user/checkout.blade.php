        ...
        <div class="row mb-4">
            <div class="col-lg-12">
                <h6>
                   ...
                   Vui lòng nhập đầy đủ thông tin để hoàn tất đơn hàng.
                </h6>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-12">
                ...
                <div class="checkout__input mt-3">
                    ...
                    <input type="text" name="order_notes" placeholder="Ví dụ: Giao vào buổi sáng, không gọi trước...">
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-12 mt-4 mt-lg-0">
                <div class="checkout__order">
                    ...
                    <div class="checkout__order__subtotal">
                        Tạm tính <span>{{ number_format($subtotal, 0, ',', '.') }}đ</span>
                    </div>
                    ...
                    <div class="checkout__order__total">
                        Tổng cộng <span>{{ number_format($total, 0, ',', '.') }}đ</span>
                    </div>
                    ...
                    <button type="submit" class="site-btn mt-4 w-100">ĐẶT HÀNG</button>
                </div>
            </div>
        </div>
    </form>
